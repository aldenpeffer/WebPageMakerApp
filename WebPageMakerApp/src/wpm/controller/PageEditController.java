...
import static wpm.PropertyType.REMOVE_CONFIRMATION_MESSAGE;
import static wpm.PropertyType.REMOVE_CONFIRMATION_TITLE;
...
public class PageEditController {
    ...
    public void handleRemoveElementRequest() {
	    ...
	    TreeItem selectedItem = (TreeItem) tree.getSelectionModel().getSelectedItem();                       
            ...
            //Confirms to delete selected tag and its children
            PropertiesManager props = PropertiesManager.getPropertiesManager();
            AppYesNoCancelDialogSingleton yesNoDialog = AppYesNoCancelDialogSingleton.getSingleton();
            yesNoDialog.show(props.getProperty(REMOVE_CONFIRMATION_TITLE), props.getProperty(REMOVE_CONFIRMATION_MESSAGE));
           
            if(yesNoDialog.getSelection().equals("Yes")){
                //Remove children and original node
